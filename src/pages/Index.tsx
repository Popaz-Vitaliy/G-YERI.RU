    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="py-16 px-4 md:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Откройте для себя наши самые популярные товары этого сезона.
            Каждый предмет тщательно отобран для вашего гардероба.
          </p>
        </div>
      ...
      <section className="py-16 px-4 md:px-8 bg-neutral-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-playfair font-bold mb-4">Категории</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { name: 'Женская одежда', image: 'https://images.unsplash.com/photo-1612336307429-8a898d10e223?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60' },
              { name: 'Мужская одежда', image: 'https://images.unsplash.com/photo-1516826957135-700dedea698c?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60' },
              { name: 'Аксессуары', image: 'https://images.unsplash.com/photo-1591321237000-c4d86fa6820b?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60' }
            ].map((category, index) => (
              <div key={index} className="group relative h-80 overflow-hidden rounded-lg">
                <div 
      ...
      <section className="py-16 px-4 md:px-8 bg-[#6E59A5] text-white">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between">
          <div className="mb-8 md:mb-0 text-center md:text-left">
            <h2 className="text-3xl md:text-4xl font-playfair font-bold mb-4">Качество и стиль</h2>
            <p className="max-w-md opacity-90">
              Мы предлагаем только лучшие материалы и дизайн, чтобы вы чувствовали себя уверенно в любой ситуации.
            </p>
          </div>
